      ...
      <div className="flex w-full flex-col pt-4 gap-8 mt-4">
        ...
        <div className="flex w-full justify-start items-center gap-2.5 pl-2.5">
          ...
          <Link href="/dashboard">
            ...
            className={`flex min-h-4 items-center justify-between hover:text-white rounded-lg px-2.5 py-2 ${selectedItem === "Dashboard" ? "bg-brand_periwinkle text-white" : ""}`}>              
          ...
          <Link href="/posts">
            ...
            className={`flex min-h-4 items-center justify-between hover:text-white rounded-lg px-2.5 py-2 ${selectedItem === "Posts" ? "bg-brand_periwinkle text-white" : ""}`}>              
                <div className="flex w-full px-2 justify-between items-center">
                  <div className="flex items-center justify-start text-subheadline gap-2.5">
                    <FilePen size={16} />
          ...
          <Link href="/themes">
            ...
            className={`flex min-h-4 items-center justify-between hover:text-white rounded-xl px-2.5 py-2 ${selectedItem === "Themes" ? "bg-brand_periwinkle text-white" : ""}`}>
              <div className="flex w-full px-2 justify-between items-center">
                <div className="flex items-center justify-start text-subheadline gap-2.5">
                  <ListChecks size={16} />
          ...
          <Link href="/calendar">
            ...
            className={`flex min-h-4 items-center justify-between hover:text-white rounded-xl px-2.5 py-2 ${selectedItem === "Calendar" ? "bg-brand_periwinkle text-white" : ""}`}>
              <div className="flex w-full px-2 justify-between items-center">
                <div className="flex items-center justify-start text-subheadline gap-2.5">
          ...
          <Link href="/industries">
            ...
            className={`flex min-h-4 items-center justify-between hover:text-white rounded-xl px-2.5 py-2 ${selectedItem === "Industries" ? "bg-brand_periwinkle text-white" : ""}`}>
              <div className="flex w-full px-2 justify-between items-center">
                <div className="flex items-center justify-start text-subheadline gap-2.5">
                  <Building2 size={16} />
          ...
          <Link href="/assets">
            ...
            className={`flex min-h-4 items-center justify-between hover:text-white rounded-xl px-2.5 py-2 ${selectedItem === "Assets" ? "bg-brand_periwinkle text-white" : ""}`}>
              <div className="flex w-full px-2 justify-between items-center">
                <div className="flex items-center justify-start text-subheadline gap-2.5">
                  <Folder size={16} />
